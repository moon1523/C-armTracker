...
int main(int argc, char* argv[])
{
    ...
    if(tracking){
        ...
        for(int i=0;i<100;i++){
            ...
            cout<<"\r Click the widget to show the whole model.."<<i<<"/100     "<<flush;
        }
    }
...
//         }
        ...
        if(tracking){
            ...
            if(maxSim>0){
                ...
                myWindow.spinOnce(1, true);
               myWindow.saveScreenshot("./capture2/viz/viz"+to_string(recordID)+".png");
            }
        ...
        cv::imwrite("./capture2/color/color" + to_string(recordID) +".png", display);
        cv::imwrite("./capture2/normal/normal" + to_string(recordID) +".png", quantized_images[1]);
